...
<rect class="fig-box ctx" x="20" y="40" width="230" height="80" rx="12"/><text class="fig-title" x="135" y="74" text-anchor="middle">user query</text><text class="fig-small" x="135" y="104" text-anchor="middle">trusted</text>
<rect class="fig-box model" x="300" y="40" width="260" height="80" rx="12"/><text class="fig-title" x="430" y="72" text-anchor="middle">privileged LLM</text><text class="fig-small" x="430" y="104" text-anchor="middle">writes a program; never sees tool output</text>
<rect class="fig-box world" x="620" y="20" width="560" height="200" rx="12"/><text class="fig-title" x="900" y="52" text-anchor="middle">CaMeL interpreter</text><text class="fig-mono" x="650" y="92">doc = read_file("plan.txt")</text><text class="fig-mono" x="650" y="126">to  = q_llm(doc, schema=Email)</text><text class="fig-mono" x="650" y="160">send_email(to, doc)   # policy check</text><text class="fig-small" x="900" y="200" text-anchor="middle">every value carries capabilities: {readers, sources}</text>
<rect class="fig-box world" x="620" y="300" width="560" height="80" rx="12"/><text class="fig-title" x="900" y="334" text-anchor="middle">tools / environment</text><text class="fig-small" x="900" y="364" text-anchor="middle">output is untrusted</text>
<rect class="fig-box model" x="300" y="250" width="260" height="110" rx="12" stroke-dasharray="10 6"/><text class="fig-title" x="430" y="284" text-anchor="middle">quarantined LLM</text><text class="fig-small" x="430" y="314" text-anchor="middle">parses untrusted text into a typed value</text><text class="fig-small" x="430" y="342" text-anchor="middle">no tools, no control flow</text>
<path class="fig-arrow muted" marker-end="url(#cm-muted)" d="M255,80 L295,80"/>
<path class="fig-arrow model" marker-end="url(#cm-orange)" d="M565,80 L615,80"/><text class="fig-small" x="590" y="66" text-anchor="middle">program</text>
<path class="fig-arrow" marker-end="url(#cm-navy)" d="M1100,225 L1100,295"/><text class="fig-small" x="1115" y="265">calls</text>
<path class="fig-arrow" style="stroke:#b3261e" marker-end="url(#cm-red)" d="M615,340 L565,340"/><text class="fig-small" x="590" y="326" text-anchor="middle" fill="#b3261e">raw text</text>
<path class="fig-arrow world" marker-end="url(#cm-signal)" d="M430,245 C430,200 560,176 615,176"/><text class="fig-signal fig-small" x="470" y="205">typed value</text>
<g class="fragment"><text x="20" y="200" fill="#b3261e" style="font-weight:700">injected text can change</text><text x="20" y="230" fill="#b3261e" style="font-weight:700">the <tspan class="fig-mono">value</tspan> of <tspan class="fig-mono">to</tspan> —</text><text x="20" y="260" fill="#b3261e" style="font-weight:700">never what the program does</text><text class="fig-small" x="20" y="292">and <tspan class="fig-mono">send_email</tspan> is allowed only if</text><text class="fig-small" x="20" y="318"><tspan class="fig-mono">to ∈ readers(doc)</tspan> — a policy the</text><text class="fig-small" x="20" y="344">interpreter checks, not the model</text></g>
</svg>
</div>
